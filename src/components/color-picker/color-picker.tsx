...
import {defineMessages, FormattedMessage, InjectedIntl, injectIntl} from 'react-intl';

import classNames from 'classnames';
import parseColor from 'parse-color';

import Slider, {CONTAINER_WIDTH, HANDLE_WIDTH} from '../forms/slider';
...
interface ColorPickerComponentProps {
    ...
    onChangeGradientTypeHorizontal: () => void;
    onChangeGradientTypeRadial: () => void;
    onChangeGradientTypeSolid: () => void;
    onChangeGradientTypeVertical: () => void;
...
class ColorPickerComponent extends React.Component<ColorPickerComponentProps> {
    _makeBackground (channel: 'hue' | 'saturation' | 'brightness') {
        const stops = [];
