...
const CopyPasteHOC = function (WrappedComponent) {
    interface CopyPasteWrapperProps {
        ...
        onUpdateImage: () => void;
        pasteOffset?: number;
        setClipboardItems: (items: any[][]) => void;
        setSelectedItems: (format: keyof typeof Formats) => void;
    };
    
    class CopyPasteWrapper extends React.Component<CopyPasteWrapperProps> {
        constructor (props: CopyPasteWrapperProps) {
            super(props);
            bindAll(this, [
                'handleCopy',
                'handlePaste'
