...
const UpdateImageHOC = function (WrappedComponent) {
    interface UpdateImageWrapperProps {
        format?: keyof typeof Formats;
        mode: keyof typeof Modes;
        onUpdateImage: (isVector: boolean, imageData: ImageData | string, x: number, y: number) => void;
        undoSnapshot: (format: keyof typeof Formats) => void;
        updateViewBounds: (matrix: paper.Matrix) => void;
    };
    
    class UpdateImageWrapper extends React.Component<UpdateImageWrapperProps> {
        constructor (props: UpdateImageWrapperProps) {
            super(props);
            bindAll(this, [
                'handleUpdateImage',
                'handleUpdateBitmap',
         ...
         */
        handleUpdateImage (skipSnapshot?: boolean, formatOverride?: keyof typeof Formats) {
            ...
            const actualFormat = formatOverride ? formatOverride :
                (this.props.mode in BitmapModes) ? Formats.BITMAP : Formats.VECTOR;
        ...
        handleUpdateBitmap (skipSnapshot: boolean) {
            if (!getRaster().loaded) {
        ...
        handleUpdateVector (skipSnapshot: boolean) {
