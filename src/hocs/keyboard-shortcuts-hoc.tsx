...
import CopyPasteHOC from './copy-paste-hoc';
...
const KeyboardShortcutsHOC = function (WrappedComponent) {
    interface KeyboardShortcutsWrapperProps {
        changeMode: (mode: keyof typeof Modes) => void;
    ...
    class KeyboardShortcutsWrapper extends React.Component<KeyboardShortcutsWrapperProps> {
        constructor (props: KeyboardShortcutsWrapperProps) {
            super(props);
            bindAll(this, [
                'handleKeyPress',
                'changeToASelectMode',
